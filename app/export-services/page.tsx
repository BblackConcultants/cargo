    ...
    <div>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image
            src="/images/export-services-bg.jpg"
            alt="Export Services"
            fill
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <p className="text-xl md:text-2xl">Expert export solutions for global trade</p>
        </div>
      </section>
      ...
      <section id="overview" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#283694] mb-8">Export Services Overview</h2>
            <div className="prose prose-lg">
              <p>
                Our comprehensive export services help businesses expand their reach globally. We manage all aspects of the export process, ensuring your goods reach international markets efficiently and compliantly.
              </p>
              <h3 className="text-xl font-semibold text-[#283694] mt-8 mb-4">Why Choose Our Export Services?</h3>
              <ul className="list-disc pl-6 space-y-2">
                <li>Complete export management solutions</li>
                <li>Expert documentation handling</li>
                <li>International customs compliance</li>
      ...
      <section id="services" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-[#283694] mb-8 text-center">Our Export Solutions</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-[#283694] mb-4">Export Management</h3>
                <ul className="space-y-2">
                  <li>Export Documentation</li>
                  <li>Customs Compliance</li>
                  <li>Trade Controls</li>
          ...
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="form-group">
                  <label htmlFor="origin">Origin (UK Location) *</label>
                  <input
                    type="text"
                    id="origin"
                    name="origin"
              ...
              <div className="form-group col-span-full">
                ...
                <textarea
                  ...
                  rows={4}
                  required
                  placeholder="Please provide details of the goods you wish to export"
                ></textarea>
              </div>
              <div className="form-group col-span-full">
      ...
      <section className="bg-[#283694] py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-8">Ready to Export?</h2>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Get in touch with us today for a free quote or to discuss your export requirements.
          </p>
