    ...
    <div>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center">
        <div className="absolute inset-0">
          <Image
            src="/images/customs-clearance-hero.jpg"
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Customs Clearance Services</h1>
          <p className="text-xl md:text-2xl">Expert customs solutions for seamless international trade</p>
        </div>
      </section>
      ...
      <section id="overview" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#283694] mb-8">Customs Clearance Overview</h2>
            <div className="prose prose-lg">
              <p>
                Our customs clearance service ensures your goods move smoothly across borders. We handle all documentation and compliance requirements, making international trade simple and efficient for your business.
              </p>
              <h3 className="text-xl font-semibold text-[#283694] mt-8 mb-4">Why Choose Our Customs Services?</h3>
              <ul className="list-disc pl-6 space-y-2">
                <li>Expert knowledge of customs regulations and procedures</li>
                <li>Fast and efficient clearance process</li>
                <li>Complete documentation handling</li>
                <li>Compliance with international trade laws</li>
                <li>Duty and VAT management</li>
      ...
      <section id="services" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-[#283694] mb-8 text-center">Our Customs Solutions</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-[#283694] mb-4">Import Services</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-[#283694] mb-4">Export Services</h3>
                <ul className="space-y-2">
      ...
      <section className="bg-[#283694] py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Get in touch with us today for a free quote or to discuss your customs clearance requirements.
          </p>
